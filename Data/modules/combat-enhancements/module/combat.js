  ...
  startup() {
    ...
    Hooks.on('renderCombatTracker', async (app, html, options) => {
      ...
      if (game.combat) {
        ...
        html.find('.ce-modify-hp').change(event => {
        ...
        if (game.user.isGM) {
          html.find('.directory-item.actor-elem')
            ...
            .on('drop', async (event) => {
              ...
              let nextCombatantElem = html.find(`.combatant[data-combatant-id="${originalCombatant._id}"] + .combatant`);
