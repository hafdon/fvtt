import SettingsUtil from "../module/settings/SettingsUtil.js";
import { CONSTANTS } from "../module/enums/Constants.js";
...
export default class DataManager extends FormApplication {
    ...
    _getSubmitData(...args) {
        if (this._advancedEditor)
            this._advancedEditor.save();
        // @ts-ignore
